...
int main(int argc, char *argv[])
{
	...
	// now hand has recorded value in the array and dealership value
	// now just need to search the table and return the right values
	print_hand(han_and_fu, dealership);
